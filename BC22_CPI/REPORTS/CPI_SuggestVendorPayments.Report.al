report 50107 "CPI Suggest Vendor Payments"
{
    ...
    begin
        with GenJnlLine do begin
            ...
            if SummarizePerVend then begin
                ...
                Description := STRSUBSTNO(Text50014, TempPaymentBuffer.Description, TempPaymentBuffer.ExtDocNo);
            END ELSE BEGIN
