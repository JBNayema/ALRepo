report 50106 "ExportElectronicPaymentFileCPI"
{
    Caption = 'Export Electronic Payment PACT';
    ProcessingOnly = true;
    UseRequestPage = false;
    // WordLayout = './LAYOUT/PACTRemittance.docx';
    RDLCLayout = './LAYOUT/ACHRemittance.rdl';
        ...
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            begin
                ...
                if TraceNumber <> '' then begin
                    ...
                    GLTranManagement.GenDistBufferGenJnlLine("Gen. Journal Line");
                ...
                if ACHFileCreated then begin
                    ...
                    case BankAccount."Export Format" of
                        BankAccount."Export Format"::US:
                            begin
                                ExportPaymentsACH.ExportOffSettingDebit;
    ...
    var
        ...
        ExportPaymentsACH: Codeunit "Export Payments (ACH) CPI";
        ...
        case BankAccount."Export Format" of
            BankAccount."Export Format"::US:
                begin
                    ...
                    ExportPaymentsACH.StartExportBatch('220', 'PPD', GenJnlLine."Source Code", SettleDate); //Citibank NACHA changed 220 and CTX
                    FileCreated := true;
                end;
            BankAccount."Export Format"::CA:
                begin
