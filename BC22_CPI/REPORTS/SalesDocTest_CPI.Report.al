report 50105 "CPI Sales Document - Test"
{
    // Serenic Navigator - (c)Copyright Serenic Software, Inc. 1999-2019.
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(IncludeLineDistributions; IncludeLineDistributions)
            {
            }
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(AccountTitle; AccountTitle)
                        {
                        }
                        column(AccountDim; AccountDim)
                        {
                        }
                        dataitem("Line Distribution Buffer"; "Line Distribution Buffer NVG")
                        {
                            DataItemLink = "Internal Control No." = FIELD("Internal Control No. NVG");
                            DataItemLinkReference = "Sales Line";
                            DataItemTableView = SORTING("Internal Control No.", "Line No.");
                            column(LDB_Internal_Control_No; "Internal Control No.")
                            {
                            }
                            column(LDB_AccountTitle; AccountTitle)
                            {
                            }
                            column(LDB_AccountDim; AccountDim)
                            {
                            }
                            column(LDB_AllocationNo; "Allocation No.")
                            {
                            }
                            column(LDB_AllocationNo_Caption; FieldCaption("Allocation No."))
                            {
                            }
                            column(LDB_Amount; Amount)
                            {
                            }
                            column(LDB_Amount_Caption; FieldCaption(Amount))
                            {
                            }
                            ...
                            begin
                                AccountDim := FundManagement.DimensionAccountGenerate("G/L Account No.", "Fund No.",
                                                             ...
                                                             "Shortcut Dimension 3 Code", "Shortcut Dimension 4 Code",
                                                            "Shortcut Dimension 5 Code", "Shortcut Dimension 6 Code",
                                                            "Shortcut Dimension 7 Code", "Shortcut Dimension 8 Code");
                            end;

                            trigger OnPreDataItem()
                            begin
                                if not IncludeLineDistributions then
                                    CurrReport.Break;
                            end;
                        }
                        ...
                        begin
                            ...
                            with "Sales Line" do begin
                                ...
                                //Navigator
                                AccountDim := FundManagement.DimensionAccountGenerate("G/L Account No. NVG", "Fund No. NVG",
                                                             "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code",
                                                             "Shortcut Dimension 3 Code NVG", "Shortcut Dimension 4 Code NVG",
                                                            "Shortcut Dimension 5 Code NVG", "Shortcut Dimension 6 Code NVG",
                                                            "Shortcut Dimension 7 Code NVG", "Shortcut Dimension 8 Code NVG");
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(IncludeLineDistributions; IncludeLineDistributions)
                    {
                        Caption = 'Include Line Distributions';
                    }
                }
            }
        }
    ...
    begin
        ...
        //Navigator
        AccountTitle := FundManagement.DimensionTitleGenerate;
    end;
    ...
    var
        ...
        AccountDim: Code[250];
        AccountTitle: Text[250];
        IncludeLineDistributions: Boolean;
    ...
    begin
        with SalesLine2 do begin
            if Abs(RemQtyToBeInvoiced) > Abs("Qty. to Ship") then begin
                ...
                if SaleShptLine.FindFirst then
                    repeat
    ...
    begin
        ...
        with SalesLine do begin
            ...
            "Dimension Set ID" :=
              ...
              //Navigator
              "Shortcut Dimension 3 Code NVG", "Shortcut Dimension 4 Code NVG", "Shortcut Dimension 5 Code NVG",
              "Shortcut Dimension 6 Code NVG", "Shortcut Dimension 7 Code NVG", "Shortcut Dimension 8 Code NVG",
